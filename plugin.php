<?php
/**
 * Plugin Name: Blocos GPR
 * Description: Blocos de layout criados exclusivamente para o site da GPR Investimentos Imobiliários
 * Author: MinimalQ
 * Author URI: https://www.minimalq.com
 * Version: 1.0
 * 
 * @package WordPress
 * @subpackage GPR-Block
 */
...
// Core constants 
define("PLUGIN_DIR", plugin_dir_path(__DIR__) . "gpr-blocks/");
define("PLUGIN_URL", plugins_url("gpr-blocks/"));
define("PLUGIN_CLASS", "GPR_Blocks");

/**
 * GPR Blocks plugin
 */
final class GPR_Blocks {
